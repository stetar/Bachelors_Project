...
//The class for the beacon objects created by the scanner
public class BeaconDeviceModel implements Comparable {
    ...
    //Beacon objects are compared by their signal value. It'll result in descending order.
    @Override
    ...
    //Updates the Mode and Average of the beacon object
    ...
    public ArrayList<Integer> getMeasures() {
        return measures;
    }

    public void setMeasures(ArrayList<Integer> measures) {
