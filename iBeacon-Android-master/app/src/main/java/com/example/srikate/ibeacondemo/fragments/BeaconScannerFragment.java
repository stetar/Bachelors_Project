...
public class BeaconScannerFragment extends Fragment implements View.OnClickListener, ResultCallback<LocationSettingsResult> {
    ...
    //For single beacon testing
    private ArrayList<Integer> rssiMesures = new ArrayList<>();
    private TextView range, average, mFrequent;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        range = view.findViewById(R.id.RSSI_range_value);
        average = view.findViewById(R.id.RSSI_average_value);
        mFrequent = view.findViewById(R.id.RSSI_most_frequent_value);
    ...
    private void foundBeacon(String uuid, final int major, final int minor, final int strength) {
        ...
        Snackbar.make(checkInBtn, "foundBeacon: Beacon (" + major + " , " + minor + ") located", Snackbar.LENGTH_SHORT).show();

        //rssiMesures.add(strength);
